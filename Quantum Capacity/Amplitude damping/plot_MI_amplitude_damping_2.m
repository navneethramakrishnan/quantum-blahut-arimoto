function plot_MI_amplitude_damping_2()

clear; 
load('data_MI_amplitude_damping.mat');
savefile = 1;
...
ylabel('Change in estimate (bits), $\Delta I^{(t)}$', 'FontSize', 40, 'Interpreter', 'latex');
...
if savefile
    ...
    % Save the pdf
    print -dpdf MI_amplitude_damping_2;
