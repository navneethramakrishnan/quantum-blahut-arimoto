function plot_degraded_BSC_rates()
...
box on;
hold on;
plot(iter_y, cy, '.-', 'Color', Blue, 'LineWidth', 3, 'MarkerSize', 10);
plot(iter_z, cz, '+-', 'Color', Red, 'LineWidth', 3, 'MarkerSize', 10);
plot(iter_yz, cyz, '*-', 'Color', Green, 'LineWidth', 3, 'MarkerSize', 10);
%plot(iter_z, cy + cz, 'x-', 'Color', Grey, 'LineWidth', 3, 'MarkerSize', 20);
