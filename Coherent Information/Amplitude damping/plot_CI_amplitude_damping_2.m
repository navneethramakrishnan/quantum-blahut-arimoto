function plot_CI_amplitude_damping_2()
...
ylabel('Change in estimate (bits), $\Delta I_{\rm{coh}}^{(t)}$', 'FontSize', 40, 'Interpreter', 'latex');
...
set(gca,'YTick',[0 0.0005 0.0010 0.0015]);
set(gca,'YTickLabel',{'0','0.0005', '0.0010', '0.0015'})
%xlim([10^23 10^26]);
...
if savefile
    ...
    % Save the pdf
    print -dpdf CI_amplitude_damping_2;
